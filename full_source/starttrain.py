...
if __name__ == "__main__":
    ...
    #
    # b = subprocess.call(
    #     ['/home/xdjf/anaconda3/envs/torch1.4_10.2/bin/python3', 'train.py', '-data',
    #      '../preprocess_TED_zh-en/IWSLT15.TED', '-save_model', 'HAN_joint_model', '-encoder_type',
    #      'transformer', '-decoder_type', 'transformer', '-enc_layers', '6', '-dec_layers', '6', '-label_smoothing',
    #      '0.1', '-src_word_vec_size', '512', '-tgt_word_vec_size', '512', '-rnn_size', '512', '-dropout', '0.1',
    #      '-batch_size', '1024', '-start_decay_at', '2', '-report_every', '500', '-epochs', '5', '-gpuid', '0',
    ...
    #      '0.1', '-max_grad_norm', '0', '-param_init', '0', '-train_part', 'all', '-context_type', 'HAN_enc',
    #      '-context_size', '3', '-train_from', '', '-complex_encoding', '-train_from',
    #      'sentence_level_model_acc_38.11_ppl_31.33_e12.pt'])
    # b_1 = subprocess.call(
    #     ['/home/xdjf/anaconda3/envs/torch1.4_10.2/bin/python3', 'train.py', '-data', '../preprocess_TED_zh-en/IWSLT15.TED', '-save_model', 'sentence_level_model',
    ...
    #      '16', '-batch_typ', 'tokens', '-normalization', 'tokens', '-accum_count', '16', '-optim', 'adam', '-adam_beta2',
    #      '0.998', '-decay_method', 'noam', '-warmup_steps', '8000', '-learning_rate', '2', '-max_grad_norm', '0',
    #      '-param_init',
    #      '0', '-param_init_glorot', '-train_part', 'sentences', '-complex_encoding'])
    # python
    ...
    # 1000 - gpu
    # 0
    c = subprocess.call(['/home/xdjf/anaconda3/envs/torch1.4_10.2/bin/python3', 'translate.py', '-model', 'HAN_joint_model_acc_38.87_ppl_29.43_e1.pt', '-src',
                         '../preprocess_TED_zh-en/IWSLT15.TED.Alltest.tc.zh', '-tgt', '../preprocess_TED_zh-en/IWSLT15.TED.Alltest.tc.en', '-doc',
                         '../preprocess_TED_zh-en/IWSLT15.TED.Alltest.zh-en.doc', '-output', 'test_out', '-translate_part', 'all',
